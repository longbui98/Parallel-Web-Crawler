...
final class SequentialWebCrawler implements WebCrawler {
	...
	@Inject
	SequentialWebCrawler(Clock clock, PageParserFactory parserFactory, @Timeout Duration timeout,
			@PopularWordCount int popularWordCount, @MaxDepth int maxDepth, @IgnoredUrls List<Pattern> ignoredUrls) {
		this.clock = clock;
	...
	private void crawlInternal(String url, Instant deadline, int maxDepth, Map<String, Integer> counts,
